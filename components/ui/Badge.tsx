...
const variantClasses: Record<BadgeVariant, string> = {
    ...
    success:
        "bg-accent-500/15 text-accent-600 dark:text-accent-400 border border-accent-500/20",
    danger:
        "bg-danger-500/15 text-danger-600 dark:text-danger-400 border border-danger-500/20",
    primary:
        "bg-primary-500/12 text-primary-700 dark:text-primary-300 border border-primary-500/20",
    gold:
