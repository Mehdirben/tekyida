...
# Android Release Compilation, and iOS verification.
# =========================================================
...
# ---------------------------------------------------------
# Step 3: Android Release Compilation
# ---------------------------------------------------------
echo "▶ Step 3: Building Android Release Package..."
cd "$ROOT_DIR/android"
...
# ---------------------------------------------------------
# Step 4: iOS Release Compilation (OS Auto-Detection)
# ---------------------------------------------------------
echo "▶ Step 4: Checking iOS Native Build (Xcode)..."
...
# ---------------------------------------------------------
# Step 5: Web Integration Smoke Test
# ---------------------------------------------------------
echo "▶ Step 5: Running Web E2E / Integration Verification..."
cd "$ROOT_DIR/frontend"
node -e '
const fs = require("fs");
