const en = {
    ...
    "settings.emailChangeError": "Failed to update email. Please try again.",
    ...
    "settings.appLockDesc": "Protect your financial data with a 6-digit PIN.",
    "settings.changePin": "Change PIN",
    "settings.biometrics": "Biometric Unlock",
    "settings.biometricsDesc": "Use Face ID or Touch ID for fast access.",
    
    // Lock Screen & Modal prompts
    "lock.title": "Tekyida is Locked",
    "lock.subtitle": "Scan Face ID / Touch ID to unlock and continue.",
    ...
    "lock.useBiometrics": "Unlock with Biometrics",
    "lock.signOut": "Sign Out & Log In Again",
    "lock.enterCurrentPin": "Enter current PIN to confirm",
    "lock.enterNewPin": "Enter new 6-digit PIN",
